...
public class PdfExportService {
    ...
    public PdfExportService(DataFromDb dataFromDb, ElementModuleRepository elementModuleRepository, IClasseService classeService, IEnseignantService enseignantService, IDepartementService departementService) {
    ...
    public void AddPageClasse(Document myPDFDoc, Classe classe) throws IOException {
        ...
        myPDFDoc.addSubject("emplois du temps pour l'EMSI");
        myPDFDoc.addKeywords("EMSI TIMETABLE");
        myPDFDoc.addCreator("Yahya");
        myPDFDoc.addAuthor("Nizar");
        ...
        String text4 = "Filiere : "+classe.getFiliere().getLibelle();
        if(annee =="1"){
        ...
        String text5 = "Semestre "+classe.getSemestre().getNum();
        //String text5 = "Semestre "+classe.getLibelle().split(" ")[1];
        String text6 = "Permanant";
